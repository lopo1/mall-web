                ...
                <div class="priceform" id="priceform" v-clickoutside="handleClickOutside">
                    <div class="form-bg">
                        <form id="freepriceform" >
                            <span class="rmb"></span>
                            <input type="text"  name="price_min" id="pricemin" v-model="state.info.price_min" @focus="focus=true">
                            <span class="rmb rmb2"></span>
                            <input type="text"  name="price_max" id="pricemax" v-model="state.info.price_max" @focus="focus=true">
...
const changePriceRange = (min:string, max:string)=> {
            emit('on-change', {min, max});
        }
 const  handleClickOutside = ()=> {
            state.info.focus = false;
