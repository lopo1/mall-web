  ...
  <div>
    <div class="c-box bg-box" >
        ...
        <div class="fr form-box">
          ...
          <form id="jsLoginForm" autocomplete="off">
            ...
            <div class="form-group marb20">
              <label>用&nbsp;户&nbsp;名</label>
              <input name="account_l" id="account_l" type="text" v-model="state.loginForm.username" @focus="errorUnshow" placeholder="手机号/账号">
            </div>
             <p class="error-text" v-show="userNameError">{{userNameError}}</p>
            <div class="form-group marb8">
              <label>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label>
              <input name="password_l" id="password_l" type="password" v-model="state.loginForm.password" @focus="errorUnshow" placeholder="请输入您的密码">
            </div>
            <div class="form-group form-groups marb8">
              <label>验&nbsp;证&nbsp;码</label>
              <input name="captcha" id="captcha" type="captcha" v-model="state.loginForm.captchacode" @focus="errorUnshow" placeholder="请输入验证码">
              <img :src="state.captcha" alt="" @click="changeCaptcha" class="captcha-img">
            </div>
     ...
     <!--        <div class="error btns login-form-tips" id="jsLoginTips" v-show="error"><p>用户名或密码错误</p></div> -->
            ...
            <input class="btn btn-green" id="jsLoginBtn" type="button" @click = "handleLogin" value="立即登录 &gt; ">
          </form>
...
const changeCaptcha = ()=>{
      getCaptcha().then(res=> {
        ...
        // state.loginForm.captcha = res.data.picPath;
        state.captcha = res.data.picPath
        state.loginForm.captcha_id = res.data.captchaId
      })
  }
  ...
  //           }
  //           if("mobile" in error){
  //             that.userNameError = error.mobile;
  //           }
  //           if("password" in error){
  //             that.parseWordError = error.password;
  //           }
  //         });
