<template>
<div>
<div class="series_list" v-for="items in seriesList">
            ...
            <div class="series_info">
                ...
                <ul class="brand">
                    ...
                    <li v-for="brand in items.brands">
                       <router-link :to="'/home/list/'+brand.id" >
                ...
                <div class="brand_cata">
                   <router-link  v-for="label in items.sub_cat" :key="label.id" :title="label.name"   :to="'/home/list/'+label.id"  >
                    {{label.name}}
                    </router-link>
                </div>
                ...
                <div class="series_pic">
                    <router-link :to="'/home/productDetail/'+items.ad_goods.id" target = _blank>
                ...
                <div class="pro_list">
                    <ul class="cle">
                        <li v-for="list in items.goods">
                             <router-link :to="'/home/productDetail/'+list.id" target = _blank>
                                <p class="pic">
...
let seriesList = computed(() => {
  return store.getters['seriesList'];
})
    const getList = ()=>{
            queryCategorygoods({})
            .then((response)=> {
                ...
                store.commit('setSeriesList',response.data);
