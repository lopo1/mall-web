    ...
    <div>
        ...
        <div class="newopro-r fr">
            <h2 class="index-tt">
                ...
                <router-link to="/home/list/more" target = _blank><a  class="fr c666">更多&gt;&gt;</a></router-link>
            </h2>
            <ul class="newgoods_fastbuy">
                <li class="prolist-cent clearfix have_num" v-for="item in newopro">
                    <div class="prolist-l fl">
                    <router-link :to="'/home/list/'+item.id"  target = _blank> <a  :title="item.name" class="imgBox">
                    ...
                    <div class="prolist-r fl">
                        ...
                        <router-link :to="'/home/list/'+item.id"  :title="item.name" target = _blank>{{item.name}}</router-link>
                        </h3>
...
//   newopro: []
// });
let newopro = computed(() => {
  return store.getters['newopro'];
})
const getOpro = ()=>{
        getGoods({
        "in":"true",
        ...
        .then((response)=> {
            ...
            store.commit('setNewopro', response.data.data);
            // state.newopro = response.data.data
        })
